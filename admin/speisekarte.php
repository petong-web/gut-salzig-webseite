...
<title>Speisekarte — gut salzig Admin</title>
...
<main class="main">
  ...
  <div class="topbar">
    <h1>✦ <em>Speisekarte</em></h1>
    <a href="speisekarte-edit.php" class="btn-new">+ Neu erstellen</a>
  </div>
      ...
      <table>
        ...
        <?php foreach ($items as $item): ?>
          <tr>
            ...
            <td class="actions">
              <a href="speisekarte-edit.php?id=<?= $item['id'] ?>">Bearbeiten</a>
            </td>
          </tr>
        <?php endforeach; ?>
        </tbody>
